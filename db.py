...
def default_connection():
    return psycopg2.connect(database=creds.db_name, user=creds.db_user,
                            password=creds.db_user_password)


if __name__ == "__main__":
    connection = create_connection(creds.db_name, creds.db_user,
                                   creds.db_user_password)
